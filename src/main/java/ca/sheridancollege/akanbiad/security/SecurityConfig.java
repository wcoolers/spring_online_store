...
public class SecurityConfig {
	...
	public SecurityFilterChain filterChain(HttpSecurity http, MvcRequestMatcher.Builder mvc) throws Exception {
		...
		requests.requestMatchers(mvc.pattern("/secure/**")).hasAnyRole("USER", "ADMIN") //only user and admin can access /secure path
		.requestMatchers(mvc.pattern("/admin/**")).hasRole("ADMIN") //only admin can access /admin path
